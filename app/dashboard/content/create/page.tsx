...
import { createContent, type ContentType, checkContentExists } from "@/lib/actions/content-actions"
...
export default function CreateContentPage() {
  ...
  const validateForm = async () => {
    ...
    if (title.trim()) {
      const result = await checkContentExists(title.trim())
      if (result.success && result.exists) {
        newErrors.title = "Ya existe un contenido con este título"
      }
    }
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "El contenido ha sido creado correctamente",
        })
        ...
        toast({
          title: "Error",
          description: result.error || "No se pudo crear el contenido",
          variant: "destructive",
        })
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "Ocurrió un error al crear el contenido",
        variant: "destructive",
      })
    } finally {
      setIsSubmitting(false)
  ...
  return (
    <>
      <DashboardHeader heading="Crear Contenido" text="Crea un nuevo recurso educativo">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Card className="border-purple-900/50 bg-black/50 backdrop-blur-sm shadow-[0_0_15px_rgba(139,92,246,0.1)]">
            <CardHeader>
              ...
              <CardDescription>Proporciona la información básica del contenido</CardDescription>
            </CardHeader>
            ...
            <TabsContent value="document" className="space-y-4">
              <Card className="border-purple-900/50 bg-black/50">
                <CardHeader>
                  ...
                  <CardDescription>Escribe o pega el contenido del documento</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    <SimpleTextEditor
            ...
            <TabsContent value="video" className="space-y-4">
              <Card className="border-cyan-900/50 bg-black/50">
                <CardHeader>
                  ...
                  <CardDescription>Proporciona la URL y detalles del video</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
            ...
            <TabsContent value="quiz" className="space-y-4">
              <Card className="border-amber-900/50 bg-black/50">
                <CardHeader>
                  ...
                  <CardDescription>Crea las preguntas y respuestas para el quiz</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="assignment" className="space-y-4">
              <Card className="border-pink-900/50 bg-black/50">
                <CardHeader>
                  ...
                  <CardDescription>Define la tarea y sus requisitos</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
          ...
          <div className="flex justify-end">
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <Save className="mr-2 h-4 w-4" /> Guardar Contenido
                </>
              )}
            </Button>
          </div>
